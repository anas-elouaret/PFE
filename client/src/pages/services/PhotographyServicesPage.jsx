...
import { services, bundles, categories } from "../../data/photographyServicesData";
      ...
      <Container>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-3xl mx-auto mb-10">
          <Badge variant="premium" className="mb-4">
            ...
            {t("services.photography.heroBadge")}
          </Badge>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4 tracking-tight">
            {t("services.photography.title")}
          </h1>
          <p className="text-lg text-zinc-500 max-w-2xl mx-auto">
            {t("services.photography.heroDesc")}
          </p>
        </motion.div>
